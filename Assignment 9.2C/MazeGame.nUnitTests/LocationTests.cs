...
namespace MazeGame.nUnitTests
{
    public class LocationTests
    {
        ...
        [Test]
        public void Test_LocationLocatesPathID()
        {
            var sut = garden.Locate("n");
            Assert.That(sut, Is.EqualTo(gardenPath1));
            Console.WriteLine(sut);
        }

        [Test]
        public void Test_LocationLocatesInvalidPath()
        {
            var sut = garden.Locate("s");
            Assert.That(sut, Is.Not.EqualTo(gardenPath1));
            Console.WriteLine(sut);
        }

        [Test]
        public void Test_LocationLocatesPathName()
        {
            var sut = garden.Locate("east");
            Assert.That(sut, Is.EqualTo(gardenPath2));
            Console.WriteLine(sut);
        }
