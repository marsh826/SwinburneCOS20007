...
///////////Commands//////////////
Command look = new LookCommand(new string[] { "look", "Look" });
Command move = new MoveCommand(new string[] { "move", "go", "head", "leave" });
...
/*foreach(Paths way in garden.PathList)
{
    Console.WriteLine(way.FullDescription);
}*/
...
while (true)
{
    ...
    if (string.Equals(cmdArray[0], "look", StringComparison.OrdinalIgnoreCase))
    {
    ...
    {
        Console.WriteLine(move.Execute(_player, cmdArray));
        Console.WriteLine("");
    }
