namespace MazeGame.nUnitTests
{
    public class MoveCommandTests
    {
        ...
        [Test]
        public void Test_LeavePath()
        {
            Console.WriteLine($"Before moving north: {_player.CurrentLocation.Name}");
            var sut = move.Execute(_player, new string[] { "leave", "n" });
        ...
        [Test]
        public void Test_MoveInvalidPath()
        {
            Console.WriteLine($"Before moving west: {_player.CurrentLocation.Name}");
            var sut = move.Execute(_player, new string[] { "move", "west" });
            string expectedPath = "I can't find path: west";

            Assert.Multiple(() =>
            {
                Assert.That(sut, Is.EqualTo(expectedPath));
                Assert.That(_player.CurrentLocation, Is.EqualTo(garden));
            });
            Console.WriteLine($"After moving west: {_player.CurrentLocation.Name}");
            Console.WriteLine(sut);
        }
